(function (global, factory) {
  ...
  function () {
    ...
    Decimal.prototype.tetrate = function(height = 2) {
      x = new Decimal(this)
      if(x.eq(1)) return x
      if(height%1 == 0) return x.tetration(height)
      height = new Decimal(height)
      let x1 = x.tetration(height.floor())
      let x2 = 0
      let x3 = x.tetration(height.ceil())
      if(x.lt(1.4447)) return x1.times(x3.div(x1).pow(height.minus(height.floor())))
    ...
    Decimal.prototype.tetration = function(height = 2) {
      ...
      if(x.eq(0)) {
        if(height%2 == 0) return new Decimal(1)
